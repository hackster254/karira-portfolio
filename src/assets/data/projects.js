...
const projects = [
  {
    ...
    name: 'Notes App',
    desc:
      'An application to record and organize your notes. I developed the web app using REACTJS and localstorage.',
    img: UTrackerImg,
  ...
  },
  {
    ...
    desc:
      'This is a water purifier project that uses solar to clean water. It is based on ESP32 module that collects water flow statistics.',
    img: GreenCtgImg,
  ...
  },
  {
    ...
    desc:
      'This is a Grocery management application with Visual Basic and mySQL database with crystal reports. The desktop application allows the owner to track orders and stock supply.',
    img: CoinTrackerImg,

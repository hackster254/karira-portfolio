  ...
  return (
    <TestimonialSectionStyles>
      <div className="container">
        <SectionTitle subheading="Work Experience" heading="EXPERIENCE" />
            ...
            <CSSTransition key={activeSlide.id} timeout={300} classNames="fade">
              <div className="testimonial__info">
                <div className="testimonial__desc">
                  ...
                  <PText>
                    {activeSlide.desc1.map((p) => (
                      <>
                        <List bulleted ordered>
                          <List.Item>{p.role1}</List.Item>
                          <List.Item>{p.role2}</List.Item>
                        </List>
                      </>
                    ))}
                  </PText>
                ...
                <p className="testimonial__title">
                  {activeSlide.date}, <br /> {activeSlide.org}
                </p>
              </div>
            </CSSTransition>
          </SwitchTransition>
